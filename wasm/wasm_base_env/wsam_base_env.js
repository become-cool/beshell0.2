...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'wsam_base_env.data';
      var REMOTE_PACKAGE_BASE = 'wsam_base_env.data';
...
Module['FS_createPath']("/", "files", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_wsam_base_env.data');

      };
      Module['addRunDependency']('datafile_wsam_base_env.data');
    ...
    loadPackage({"files": [{"filename": "/files/.gitignore", "start": 0, "end": 0}], "remote_package_size": 0, "package_uuid": "dea1f55a-24f0-409f-bbb1-a2cb1a7483a1"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'wsam_base_env.wasm';
