class ST77XX {
    ...
    begin(bus, cs, dc, freq) {
        this.spi = serialapi.spiDeviceAdd(bus, cs, freq||26000000, 0)
        this.dc = dc
        pinMode(dc, "output")
    }
    ...
    fillRect (x1,y1, x2,y2, red, green, blue) {
        ...
        for( ; n>0; n-=20480) {
            serialapi.spiSend(this.spi, buff.buffer, 0, (n>=20480)? 20480: n)
        }
    }
    ...
    sendCommand(cmd) {
        ...
        serialapi.spiSend(this.spi, new Uint8Array([cmd]).buffer)
    }
    sendCmdSeq(seq){
    ...
    sendData(data) {
        ...
        serialapi.spiSend(this.spi, data)
    }
}
...
// ST7796
class BeScreen4i extends ST77XX {
    constructor(spi, cs, dc, res){
        super(spi, dc, cs, res)
        this._ox = 1
        this._oy = 1
...
module.exports = {
    ST77XX, BeScreen096i, BeScreen130i, BeScreen4i
}