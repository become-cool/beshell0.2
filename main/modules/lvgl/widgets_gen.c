...
static JSValue js_lv_obj_add_state(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    if(JS_ToUint32(ctx, (uint32_t *) &state, argv[0])!=0){
        THROW_EXCEPTION("arg state of method Obj.addState() must be a number")
    }
...
static JSValue js_lv_obj_clear_state(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    uint32_t state ;
    if(JS_ToUint32(ctx, (uint32_t *) &state, argv[0])!=0){
        THROW_EXCEPTION("arg state of method Obj.clearState() must be a number")
    }
...
static JSValue js_lv_obj_has_state(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv) {
    ...
    uint32_t state ;
    if(JS_ToUint32(ctx, (uint32_t *) &state, argv[0])!=0){
        THROW_EXCEPTION("arg state of method Obj.hasState() must be a number")
    }
...
// AUTO GENERATE CODE START [REGISTER CLASS] --------
    ...
    JSValue proto_lv_msgbox = qjs_def_class(ctx, "MsgBox", js_lv_msgbox_class_id, &js_lv_msgbox_class
                , "lvgl.MsgBox", js_lv_msgbox_constructor, js_lv_msgbox_proto_funcs, countof(js_lv_msgbox_proto_funcs), proto_lv_obj, lvgl) ;
    ...
    JSValue proto_lv_keyboard = qjs_def_class(ctx, "Keyboard", js_lv_keyboard_class_id, &js_lv_keyboard_class
                , "lvgl.Keyboard", js_lv_keyboard_constructor, js_lv_keyboard_proto_funcs, countof(js_lv_keyboard_proto_funcs), proto_lv_obj, lvgl) ;
